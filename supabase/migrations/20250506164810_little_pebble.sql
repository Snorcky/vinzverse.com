...
-- Create initial admin user (will be populated from auth)
INSERT INTO profiles (id, email, name, title, bio)
VALUES (
  '00000000-0000-0000-0000-000000000000', 
  'gillaux.vincent@gmail.com',
  'Vincent Gillaux',
  'Software Developer',
  'Experienced developer with a passion for creating elegant, user-friendly applications.'
)
